...
def parse_args() -> argparse.Namespace:
    ...
    # 新增 LARC 和 RuleEncoder 相关参数
    parser.add_argument("--use-larc", action="store_true", help="Enable LARC language alignment")
    parser.add_argument("--clip-embeddings-path", type=str, default=None, help="Path to precomputed CLIP embeddings")
    parser.add_argument("--larc-weight", type=float, default=0.1, help="Weight for LARC loss")
    parser.add_argument("--k-shot", type=int, default=3, help="Number of support examples for RuleEncoder")
